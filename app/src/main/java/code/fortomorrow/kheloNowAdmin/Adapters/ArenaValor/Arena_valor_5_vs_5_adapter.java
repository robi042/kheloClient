...
public class Arena_valor_5_vs_5_adapter extends RecyclerView.Adapter<Arena_valor_5_vs_5_adapter.MyViewHolder> {
    String totalPlayer;
    Arena_of_valor_5_vs_5_slot_activity activity;
    ...
    public Arena_valor_5_vs_5_adapter(String totalPlayer, Arena_of_valor_5_vs_5_slot_activity activity, List<Check_join_team_response.M> joinedPlayerList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.arena_of_valor_5_vs_5_card, parent, false);
    ...
    public int getItemCount() {
        return Integer.parseInt(totalPlayer) / 5;
    }

    public static class MyViewHolder extends RecyclerView.ViewHolder {
        TextView countText;
        CheckBox playerACheckBox, playerBCheckBox, playerCCheckBox, playerDCheckBox, playerECheckBox;
