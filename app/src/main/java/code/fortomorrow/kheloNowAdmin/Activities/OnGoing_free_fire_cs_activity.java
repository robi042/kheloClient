...
public class OnGoing_free_fire_cs_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_going_free_fire_cs);
        ...
        freeFireCsRegularMatchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), OnGoing_activity.class);
