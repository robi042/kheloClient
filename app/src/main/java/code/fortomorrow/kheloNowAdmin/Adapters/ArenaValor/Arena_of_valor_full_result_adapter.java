...
public class Arena_of_valor_full_result_adapter extends RecyclerView.Adapter<Arena_of_valor_full_result_adapter.ViewHolder> {
    private List<Arena_valor_result_match_info.M> infoList;

    public Arena_of_valor_full_result_adapter(List<Arena_valor_result_match_info.M> infoList) {
        this.infoList = infoList;
    }

    @NonNull
    @Override
    public Arena_of_valor_full_result_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.arena_of_valor_result_details_card, parent, false);
        return new Arena_of_valor_full_result_adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Arena_of_valor_full_result_adapter.ViewHolder holder, int position) {
