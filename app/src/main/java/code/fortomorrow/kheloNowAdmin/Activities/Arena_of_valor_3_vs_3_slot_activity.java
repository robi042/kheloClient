...
import code.fortomorrow.kheloNowAdmin.Adapters.ArenaValor.Arena_valor_3_vs_3_adapter;
...
public class Arena_of_valor_3_vs_3_slot_activity extends AppCompatActivity {
    ...
    private Arena_valor_3_vs_3_adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arena_of_valor_3_vs_3_slot);
        ...
        apiService.arena_of_valor_join_player_list(secret_id, jwt_token, matchID).enqueue(new Callback<Check_join_team_response>() {
            ...
            public void onResponse(Call<Check_join_team_response> call, Response<Check_join_team_response> response) {
                if (response.body().getE() == 0) {
                    ...
                    adapter = new Arena_valor_3_vs_3_adapter(totalPlayer, Arena_of_valor_3_vs_3_slot_activity.this, joinedPlayerList);
