...
import code.fortomorrow.kheloNowAdmin.Adapters.FreeFireJoin.Six_vs_six_join_adapter;
...
public class Free_fire_six_vs_six_match_join_activity extends AppCompatActivity {

    ImageView backButton;
    String totalPlayer;
    RecyclerView itemRecyclerView;
    Six_vs_six_join_adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_free_fire_six_vs_six_match_join);
        ...
        apiService.getJoinedList(secret_id, jwt_token, match_Id).enqueue(new Callback<Joined_player_list_response>() {
            ...
            public void onResponse(Call<Joined_player_list_response> call, Response<Joined_player_list_response> response) {
                if (response.body().getE() == 0) {
                    ...
                    adapter = new Six_vs_six_join_adapter(totalPlayer, Free_fire_six_vs_six_match_join_activity.this, joinedPlayerList);
        ...
        joinNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(selectedPosition)) {
                    ...
                    if (stateA || stateB || stateC || stateD || stateE || stateF) {
    ...
    public void get_player_data(String position, Boolean aState, Boolean bState, Boolean cState, Boolean dState, Boolean eState, Boolean fState) {
        ...
        //Toast.makeText(getApplicationContext(), selectedPosition + " " + String.valueOf(stateA) + " " + String.valueOf(stateB) + " " + String.valueOf(stateC) + " " + String.valueOf(stateD) + " " + String.valueOf(stateE) + " " + String.valueOf(stateF), Toast.LENGTH_SHORT).show();
